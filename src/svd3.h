...
#define _gamma 5.8284271247461900976033774484194 // FOUR_GAMMA_SQUARED = sqrt(8)+3;
#define _cstar 0.92387953251128675612818318939679 // cos(pi/8)
#define _sstar 0.3826834323650897717284599840304 // sin(p/8)
#define EPSILON 1e-6

#include "math.h"

/* This is a novel and fast routine for the reciprocal square root of an
IEEE double (single precision).
...
//// double xhalf = *(double *)&ihalf;      // for sufficiently large nos.
//   double xhalf = 0.5f*x;
//   long i = *(long *)&x;          // View x as an int.
//// i = 0x5f3759df - (i >> 1);   // Initial guess (traditional).
//   i = 0x5f375a82 - (i >> 1);   // Initial guess (slightly better).
//   x = *(double *)&i;            // View i as double.
